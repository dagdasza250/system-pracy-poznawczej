...
- [ ] Uczestnik pilotażu jest określony jako P01.
- [ ] Klasa spraw jest jednoznacznie zawężona.
- [ ] Problem poznawczy jest określony.
- [ ] V1 ma definicję i granice.
- [ ] V2 ma definicję i granice.
- [ ] V3 ma definicję i granice.
- [ ] V4 ma definicję i granice.
- [ ] C1 ma definicję.
- [ ] C2 ma definicję.
- [ ] Non-claims są zaakceptowane.
- [ ] Przyjęto wektorowy model wyniku.
- [ ] Przyjęto zakaz miar osieroconych.
- [ ] Potwierdzono, że R1 nie zmienia ontologii ani aplikacji v0.5.1.
- [ ] Dokument został podpisany przed rozpoczęciem R2.
...
**Identyfikator osoby zatwierdzającej:** ____________________

**Data:** ____________________

**Uwagi / warunki zatwierdzenia:**  
...
Do tego momentu R2, R3, R4, R5 i właściwe sesje R6 pozostają zablokowane.
